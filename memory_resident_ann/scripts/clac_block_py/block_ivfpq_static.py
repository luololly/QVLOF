...
def main(in_name, block_size_str, ef_value, k_value) -> int:
    ...
    with open(in_path, "r", encoding="utf-8", newline="") as f:
        ...
        # 找到 nprobe/k 列索引（用于筛选）
        try:
            ef_idx = header.index("nprobe")
            k_idx = header.index("k")
        except ValueError:
            print("CSV must contain columns named 'nprobe' and 'k'.", file=sys.stderr)
            return 1
        ...
        # 只处理 nprobe==X 且 k==Y 的行，并且输出也只输出这些行
...
if __name__ == "__main__":
    # main(r'C:\Users\Launcher\Desktop\静态向量索引实验_deep\IVFPQ\ivfpq_ids_base.csv', '100', '1024', '1000')
    main(r'C:\Users\Launcher\Desktop\静态向量索引实验_V5\IVFPQ\ivfpq_ids_f1_AG_k500.csv', '10000', '1024', '500')