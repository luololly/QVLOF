...
def main() -> int:
    parser = argparse.ArgumentParser(description="Summarize MARGO partition-sector access counts from a vector-id CSV.")
    ...
    print(f"Wrote MARGO block summary to {Path(result)}")
    return 0
