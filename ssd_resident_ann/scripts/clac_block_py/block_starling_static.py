...
def main() -> int:
    parser = argparse.ArgumentParser(description="Summarize Starling partition-page access counts from a vector-id CSV.")
    ...
    print(f"Wrote Starling block summary to {Path(result)}")
    return 0
